...
class Edrone():
    ...
    #   8. Add error_sum
            ...
            self.timechange=self.start-self.sample_time
            ...
            for i in range(4):
                self.error_2[i]=(self.error[i]-self.prev_values[i])/self.timechange

                
        
            
            for i in range(4):
                self.error_sum=self.error_sum+(self.error[i]*self.timechange)
