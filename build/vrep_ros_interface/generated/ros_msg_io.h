...
void write__plutodrone__PlutoPilotResponse(const plutodrone::PlutoPilotResponse& msg, int stack, const WriteOptions *opt = NULL);
void read__plutodrone__PlutoPilotResponse(int stack, plutodrone::PlutoPilotResponse *msg, const ReadOptions *opt = NULL);
...
void write__aruco_msgs__MarkerArray(const aruco_msgs::MarkerArray& msg, int stack, const WriteOptions *opt = NULL);
void read__aruco_msgs__MarkerArray(int stack, aruco_msgs::MarkerArray *msg, const ReadOptions *opt = NULL);
...
void write__plutodrone__PlutoMsg(const plutodrone::PlutoMsg& msg, int stack, const WriteOptions *opt = NULL);
void read__plutodrone__PlutoMsg(int stack, plutodrone::PlutoMsg *msg, const ReadOptions *opt = NULL);
...
void write__plutodrone__PlutoPilotRequest(const plutodrone::PlutoPilotRequest& msg, int stack, const WriteOptions *opt = NULL);
void read__plutodrone__PlutoPilotRequest(int stack, plutodrone::PlutoPilotRequest *msg, const ReadOptions *opt = NULL);
...
void write__aruco_msgs__Marker(const aruco_msgs::Marker& msg, int stack, const WriteOptions *opt = NULL);
void read__aruco_msgs__Marker(int stack, aruco_msgs::Marker *msg, const ReadOptions *opt = NULL);
...
void ros_callback__aruco_msgs__MarkerArray(const boost::shared_ptr<aruco_msgs::MarkerArray const>& msg, SubscriberProxy *proxy);
...
void ros_callback__plutodrone__PlutoMsg(const boost::shared_ptr<plutodrone::PlutoMsg const>& msg, SubscriberProxy *proxy);
...
void ros_callback__aruco_msgs__Marker(const boost::shared_ptr<aruco_msgs::Marker const>& msg, SubscriberProxy *proxy);
