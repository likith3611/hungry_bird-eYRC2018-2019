    ...
    else if(in->topicType == "aruco_msgs/MarkerArray")
    {
        subscriberProxy->subscriber = nh->subscribe<aruco_msgs::MarkerArray>(in->topicName, in->queueSize, boost::bind(ros_callback__aruco_msgs__MarkerArray, _1, subscriberProxy));
    }
    ...
    else if(in->topicType == "plutodrone/PlutoMsg")
    {
        subscriberProxy->subscriber = nh->subscribe<plutodrone::PlutoMsg>(in->topicName, in->queueSize, boost::bind(ros_callback__plutodrone__PlutoMsg, _1, subscriberProxy));
    }
    ...
    else if(in->topicType == "aruco_msgs/Marker")
    {
        subscriberProxy->subscriber = nh->subscribe<aruco_msgs::Marker>(in->topicName, in->queueSize, boost::bind(ros_callback__aruco_msgs__Marker, _1, subscriberProxy));
    }
