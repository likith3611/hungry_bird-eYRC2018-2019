    ...
    {
        publisherProxy->publisher = nh->advertise<aruco_msgs::MarkerArray>(in->topicName, in->queueSize, in->latch);
    }
    ...
    {
        publisherProxy->publisher = nh->advertise<plutodrone::PlutoMsg>(in->topicName, in->queueSize, in->latch);
    }
    ...
    {
        publisherProxy->publisher = nh->advertise<aruco_msgs::Marker>(in->topicName, in->queueSize, in->latch);
    }
