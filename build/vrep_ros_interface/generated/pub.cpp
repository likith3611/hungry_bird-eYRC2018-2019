    ...
    else if(publisherProxy->topicType == "aruco_msgs/MarkerArray")
    {
        aruco_msgs::MarkerArray msg;
        read__aruco_msgs__MarkerArray(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "plutodrone/PlutoMsg")
    {
        plutodrone::PlutoMsg msg;
        read__plutodrone__PlutoMsg(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "aruco_msgs/Marker")
    {
        aruco_msgs::Marker msg;
        read__aruco_msgs__Marker(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
