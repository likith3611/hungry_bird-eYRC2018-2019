...
set(MSG_I_FLAGS "-Iplutodrone:/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/srv/PlutoPilot.srv" NAME_WE)
add_custom_target(_plutodrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plutodrone" "/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/srv/PlutoPilot.srv" ""
)

get_filename_component(_filename "/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/msg/PlutoMsg.msg" NAME_WE)
add_custom_target(_plutodrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plutodrone" "/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/msg/PlutoMsg.msg" ""
)
...
_generate_msg_cpp(plutodrone
  "/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/msg/PlutoMsg.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(plutodrone
  "/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutodrone/srv/PlutoPilot.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/plutodrone
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/plutodrone)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/plutodrone\")")
  # install generated code
  install(
