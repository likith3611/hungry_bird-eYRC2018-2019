// Generated by gencpp from file brics_actuator/JointPositions.msg
// DO NOT EDIT!
...
{
ros::message_operations::Printer< ::brics_actuator::JointPositions_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/melodic/share/std_msgs/cmake/../msg'], 'brics_actuator': ['/home/cry2ra5y/my_catkin_workspace/src/brics_actuator/msg'], 'geometry_msgs': ['/opt/ros/melodic/share/geometry_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::brics_actuator::JointPositions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::brics_actuator::JointPositions_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::brics_actuator::JointPositions_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::brics_actuator::JointPositions_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::brics_actuator::JointPositions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::brics_actuator::JointPositions_<ContainerAllocator> const>
  : FalseType
  { };
...
struct MD5Sum< ::brics_actuator::JointPositions_<ContainerAllocator> >
{
  ...
  static const char* value(const ::brics_actuator::JointPositions_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2b7638f5c85f5257ULL;
  static const uint64_t static_value2 = 0xbef140a00cd0eec3ULL;
};

template<class ContainerAllocator>
struct DataType< ::brics_actuator::JointPositions_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::brics_actuator::JointPositions_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::brics_actuator::JointPositions_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::brics_actuator::JointPositions_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::brics_actuator::JointPositions_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.positions.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::brics_actuator::JointValue_<ContainerAllocator> >::stream(s, indent + "    ", v.positions[i]);
    }
  }
};
