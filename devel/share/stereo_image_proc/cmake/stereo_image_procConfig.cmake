...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/cry2ra5y/my_catkin_workspace/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/cry2ra5y/my_catkin_workspace/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /home/cry2ra5y/my_catkin_workspace/install)
...
if(NOT "/home/cry2ra5y/my_catkin_workspace/devel/include;/home/cry2ra5y/my_catkin_workspace/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/cry2ra5y/my_catkin_workspace/devel/include;/home/cry2ra5y/my_catkin_workspace/src/image_pipeline/stereo_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cry2ra5y/my_catkin_workspace/src/image_pipeline/stereo_image_proc/${idir}'.  ${_report}")
    endif()
