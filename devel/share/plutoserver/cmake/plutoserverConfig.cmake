...
if("TRUE" STREQUAL "TRUE")
  set(plutoserver_SOURCE_PREFIX /home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutoserver)
  set(plutoserver_DEVEL_PREFIX /home/cry2ra5y/my_catkin_workspace/devel)
  ...
  set(plutoserver_INSTALL_PREFIX /home/cry2ra5y/my_catkin_workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Simmu <simranbhangu01@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plutoserver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cry2ra5y/my_catkin_workspace/src/pluto_drone/plutoserver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(plutoserver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "plutoclient")
...
set(plutoserver_EXPORTED_TARGETS "plutoserver_generate_messages_cpp;plutoserver_generate_messages_eus;plutoserver_generate_messages_lisp;plutoserver_generate_messages_nodejs;plutoserver_generate_messages_py")
