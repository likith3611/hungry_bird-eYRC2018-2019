...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/cry2ra5y/my_catkin_workspace/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /home/cry2ra5y/my_catkin_workspace/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /home/cry2ra5y/my_catkin_workspace/install)
...
if(NOT "/home/cry2ra5y/my_catkin_workspace/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/home/cry2ra5y/my_catkin_workspace/src/geometry2/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cry2ra5y/my_catkin_workspace/src/geometry2/tf2/${idir}'.  ${_report}")
    endif()
